...
def print_species_to_terminal(tag):
    ...
    print(e_tag.antenna, e_tag.epc.species_string, "Head" if e_tag.epc.location == "0001" else "Tail", datetime.datetime.now())
...
reader.start_reading(on_time=500, callback=print_species_to_terminal)
time.sleep(600000)
reader.stop_reading()
